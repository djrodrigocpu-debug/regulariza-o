...
/* Versão curta do conteúdo de um arquivo — vira "?v=..." nos links de
   ...
   mesmo com o cache de 7 dias configurado no vercel.json. (Sem isso,
   o celular que guardou o estilo antigo mostra a foto panorâmica em
   tamanho natural e a página inteira desalinhada.) */
